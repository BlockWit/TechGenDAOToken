...
contract StagedCrowdsale is Context, Ownable {
    ...
    function addMilestone(uint256 start, 
                          uint256 end, 
                          uint256 bonus, 
                          uint256 minInvestedLimit, 
                          uint256 maxInvestedLimit, 
                          ...
                          uint256 tokensSold, 
                          uint256 hardcapInTokens,
                          uint256 freezePeriod) public onlyOwner {
        milestones.push(Milestone(start, 
                                  end, 
                                  bonus, 
                                  minInvestedLimit, 
                                  maxInvestedLimit, 
    ...
    function changeMilestone(uint8 number, 
                             uint256 start, 
                             uint256 end, 
                             uint256 bonus, 
                             uint256 minInvestedLimit, 
        ...
        milestone.freezePeriod = freezePeriod;
    }

    function insertMilestone(uint8 index, 
                             uint256 start, 
                             uint256 end, 
                             uint256 bonus, 
                             uint256 minInvestedLimit, 
        ...
        milestones[index] = Milestone(start, 
                                      end, 
                                      bonus, 
                                      minInvestedLimit, 
                                      maxInvestedLimit, 
